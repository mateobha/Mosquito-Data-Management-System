...
Se agrega el número de certificado de registro de derechos de autor ante el SENADI
(Certificado N° QUI-073095, Solicitud N° SENADI-2026-61403) a [LICENSE](LICENSE).
Se documenta la credencial inicial del usuario admin en SECURITY.md y RELEASE_NOTES.md.
